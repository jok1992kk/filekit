 ...
 * customers (the product has none pre-launch). The user will swap in real
...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    quote:
      "Switching marketplaces used to mean redoing every photo from scratch. It made that problem disappear.",
  },
];
